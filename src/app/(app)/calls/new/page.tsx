...
function NewCallForm() {
  ...
  return (
    <div className="mx-auto max-w-xl p-6 sm:p-8">
      <Card>
        <CardHeader><CardTitle>Nova call</CardTitle></CardHeader>
        <CardContent>
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5"><Label>Duração (seg)</Label><Input name="duration" type="number" min="0" placeholder="1800" /></div>
            </div>
